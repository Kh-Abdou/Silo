...
import { Moon, Sun, AlertCircle, Loader2, Mail, Lock, User, Eye, EyeOff } from "lucide-react"
                ...
                <div className="w-full max-w-md bg-card border border-border rounded-xl shadow-2xl p-8">
                    ...
                    <div className="mt-8 pt-6 border-t border-border text-center">
                        <p className="text-sm text-muted-foreground">
                            ...
                            <Link className="text-primary font-semibold hover:underline" href="/login">Sign in</Link>
                        </p>
                    </div>
                </div>
            </div>
