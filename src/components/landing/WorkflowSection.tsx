...
function StepBadge({ number }: { number: number }) {
    return (
        <div className="w-6 h-6 rounded-md bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-white/10 flex items-center justify-center text-[10px] font-bold text-zinc-900 dark:text-zinc-400 shadow-sm backdrop-blur-sm">
            {number}
        </div>
    )
}
    ...
    return (
        <div className="flex flex-col items-center text-center group relative">
            <div className="w-full aspect-square max-w-[280px] mb-8 relative flex items-center justify-center">
                ...
                {/* Floating Icon Badge */}
                <div className="absolute -top-4 -left-4 w-12 h-12 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 flex items-center justify-center text-primary shadow-sm dark:shadow-xl z-20">
                    {icon}
                </div>
                        ...
                        <WorkflowStep
                            ...
                            visual={
                                <div className="relative w-48 h-48 border-2 border-dashed border-zinc-200 dark:border-white/10 rounded-2xl flex flex-col items-center justify-center bg-zinc-50 dark:bg-white/[0.02] z-10">
                                    <UploadCloud className="text-zinc-200 dark:text-white/10 w-10 h-10 mb-2" />
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-300 dark:text-white/20">Drop anything</span>

                                    {/* Floating Social Icons */}
                                    <div className="absolute -top-6 -right-6 w-10 h-10 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-full flex items-center justify-center animate-landing-float shadow-sm dark:shadow-lg" style={{ animationDelay: "0s" }}>
                                        <svg className="w-5 h-5 text-zinc-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                        </svg>
                                    </div>
                                    <div className="absolute top-1/2 -left-8 w-10 h-10 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-full flex items-center justify-center animate-landing-float shadow-sm dark:shadow-lg" style={{ animationDelay: "2s" }}>
                                        <svg className="w-5 h-5 text-zinc-900 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div className="absolute bottom-4 -right-4 w-10 h-10 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-full flex items-center justify-center animate-landing-float shadow-sm dark:shadow-lg" style={{ animationDelay: "4s" }}>
                            ...
                            visual={
                                <div className="relative w-full h-full p-8 flex flex-col items-center justify-center z-10">
                                    <div className="w-20 h-24 bg-card dark:bg-zinc-800 rounded-lg border border-border dark:border-white/10 flex flex-col items-center justify-center gap-2 overflow-hidden shadow-2xl relative z-10">
                                        <FileText className="text-muted-foreground/20 dark:text-white/20 w-8 h-8" />
                            ...
                            visual={
                                <div className="w-[85%] space-y-4 relative z-10">
                                    ...
                                    <div className="bg-card dark:bg-[#0A0C10] rounded-xl border border-border dark:border-white/10 shadow-2xl p-3 flex items-center gap-2 transition-transform duration-500 group-hover:-translate-y-1">
                                        <Search className="text-muted-foreground/40 dark:text-white/40 w-4 h-4" />
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        <div className="bg-zinc-50 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-lg p-2 flex items-center justify-center gap-1.5 transition-all group-hover:bg-zinc-100 dark:group-hover:bg-white/10 shadow-sm">
                                            <Filter className="w-3.5 h-3.5 text-zinc-500 dark:text-white/60" />
                                            <span className="text-[9px] font-bold text-zinc-600 dark:text-white/60 uppercase tracking-tighter">Filter</span>
                                        </div>
